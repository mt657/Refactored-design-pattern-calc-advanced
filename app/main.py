...
from app.history.logger import logging  # Import the logging instance
...
from app.calculator.calculator_observer import CalculatorWithObserver  # Use relative import
